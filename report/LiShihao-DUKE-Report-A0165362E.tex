...
\title{  \textbf{\texttt{TIC2002}} \textsf{\\ \vspace{0.3cm} \huge{INTRODUCTION TO SOFTWARE ENGINEERING }} \\ \vspace{0.2cm} \Large{\textsf{AY19/20 Semester 1}} \\ \vspace{0.8cm} \LARGE{Duke Project Report}}
\date{\small\today}
