...
\title{  \textbf{\texttt{TIC2002}} \textsf{\\ \vspace{0.3cm} \huge{INTRODUCTION TO SOFTWARE ENGINEERING }} \\ \vspace{0.2cm} \Large{\texttt{Semester 1 - AY19/20}} \\ \vspace{0.8cm} \LARGE{Duke Project Report}}
\date{\small\today}
