...
\title{  \textsf{\textbf{TIC2002} \\ \vspace{0.3cm} \huge{INTRODUCTION TO SOFTWARE ENGINEERING }} \\ \vspace{0.3cm} \huge{AY19/20 Semester 1}\\ \vspace{0.8cm} \LARGE{Duke Project Report}}
\date{\small\today}
