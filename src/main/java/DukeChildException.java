public class DukeChildException {
    ...
    //invalid command
    private static class invalidInput extends DukeBaseException {
    ...
    private static class deadDate extends DukeBaseException {
    ...
    private static class eventTime extends DukeBaseException {
