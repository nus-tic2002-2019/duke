public class Parser {
    public static Command parseInput(String userInput) throws DukeException {
        ...
        switch (input.split(" ")[0]) {
            case AddDeadlineCommand.INPUT_WORD: return new AddDeadlineCommand(false, input);
            case AddEventCommand.INPUT_WORD: return new AddEventCommand(false, input);
            case AddToDoCommand.INPUT_WORD: return new AddToDoCommand(false, input);
            case ListCommand.INPUT_WORD: return new ListCommand(false, "");
