...
public class UI {
    ...
    public void printWelcomeMessage() {
        ...
        System.out.println("To add a new deadline task, please input : deadline <taskname> /by yyyy-mm-dd hh:mm<AM/PM> e.g. yyyy-mm-dd hh:mmAM");
        System.out.println("To add a new event task, please input: event <taskname> /at yyyy-mm-dd<AM/PM> e.g. yyyy-mm-dd hh:mmAM");
        System.out.println("To add a recurring event task, please input: event <taskname> /at yyyy-mm-dd<AM/PM> e.g. yyyy-mm-dd hh:mmAM /repeat <no. of days in between> /times <no. of times>");
        System.out.println("To add a recurring deadline task, please input: deadline <taskname> /by yyyy-mm-dd<AM/PM> e.g. yyyy-mm-dd hh:mmAM /repeat <no. of days in between> /times <no. of times>");
        System.out.println("To print out task list, please input: list ");
        System.out.println("To mark task as done, please input: done ");
