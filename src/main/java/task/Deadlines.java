...
public class Deadlines extends Task {
    ...
    public Deadlines(String description, String details,boolean readFromFile){
        ...
        if (!readFromFile) {
            ...
            DateTimeFormatter aformatter = DateTimeFormatter.ofPattern("d MMM yyyy HHmm");
            LocalDateTime formattedDate = LocalDateTime.parse(details, aformatter); // change string to date
            changedDate = formattedDate.toString(); // new string date
        }
