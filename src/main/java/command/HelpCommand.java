...
public class HelpCommand extends Command{
    ...
    public void execute(TaskList tasks, Ui ui, Storage storage) throws DukeException {
        ...
        System.out.println("6)done - To add a tick to a completed task\n");
        System.out.println("6)save - To save existing task list\n");
        System.out.println("6)saveTo - To save existing task list to a specific pathing\n");
        System.out.println("6)loadFrom - To load the task list from a file\n");
    }
}
